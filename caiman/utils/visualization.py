...
def view_patches_bar(Yr, A, C, b, f, d1, d2, YrA=None, img=None,
    ...
    def update(val):
        ...
        np.savetxt("/content/drive/MyDrive/mathbio/image_processing_2/data/traces.csv", data, delimiter=",")
        pl.savefig('/content/drive/MyDrive/mathbio/image_processing_2/data/traces.jpg')
...
def plot_contours(A, Cn, thr=None, thr_method='max', maxthr=0.2, nrgthr=0.9, display_numbers=True, max_number=None,
    ...
    if display_numbers:
        ...
        pl.savefig('/content/drive/MyDrive/mathbio/image_processing_2/data/contours.jpg')
